...
export async function generateRecommendationNode(
  ...
  if (state.retrievedBooks.length === 0) {
    return {
      finalAnswer: NO_RESULTS_MESSAGE,
      history: [{ query: state.query, answer: NO_RESULTS_MESSAGE }],
    };
  }
